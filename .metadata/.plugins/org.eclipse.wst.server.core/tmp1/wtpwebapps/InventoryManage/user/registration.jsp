						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="password" class="form-control" name="password" id="username"  placeholder="Enter your password"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="phone" id="password"  placeholder="Enter your phone number"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="add" id="password"  placeholder="Enter your address"/>
								</div>
							</div>
						</div>
